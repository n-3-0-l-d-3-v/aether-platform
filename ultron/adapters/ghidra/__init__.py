...
Ultron does not disassemble, decompile, or recover control flow. Ghidra does
...
those things, Ultron inherits the improvement without a line changing here.
...
from ultron.adapters.base import Adapter, AdapterResult, Availability, run_process, which
from ultron.adapters.ghidra import importer
from ultron.adapters.triage import TriageAdapter
from ultron.adapters.triage.detectors import RISKY_APIS
from ultron.errors import AdapterError, AdapterUnavailable
...
GHIDRA_ENV_VARS = ("ULTRON_GHIDRA_HOME", "GHIDRA_INSTALL_DIR", "GHIDRA_HOME")
