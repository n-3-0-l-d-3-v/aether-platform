...
Because of that, execution never happens implicitly. ``ultron analyze`` will
...
isolated machine can be imported anywhere with ``ultron import-trace``.
"""
...
class QemuAdapter(Adapter):
        ...
        if not self._binary:
            ...
            return Availability(
                ...
                remedy=(
                    ...
                    "ultron import-trace <log> --object <file>."
                ),
                cost=(
    ...
    def analyze(
        ...
        *,
        ...
        with tempfile.TemporaryDirectory(prefix="ultron-qemu-") as scratch:
