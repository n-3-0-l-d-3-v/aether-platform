...
from ultron.adapters.base import Adapter, AdapterResult, Availability
from ultron.adapters.triage import detectors, formats, strings
...
class TriageAdapter(Adapter):
    ...
    def triage_into(
        ...
        *,
        ...
        hundreds of runs.
        """
        from ultron.adapters.ingest import ingest_file
