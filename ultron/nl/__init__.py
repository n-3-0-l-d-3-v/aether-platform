...
returns an :class:`~ultron.nl.model.Answer` whose every explanatory line cites
...
from ultron.nl.questions import (
    MATCH_THRESHOLD,
    QUESTION_TYPES,
    PlanContext,
    QuestionType,
...
from ultron.util import hex_addr

#: Cap on claims pulled per predicate. An answer is a summary; a reviewer who
#: wants every row uses `ultron query claims`.
