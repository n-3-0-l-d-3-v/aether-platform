...
Yugen does not disassemble, decompile, or recover control flow. Ghidra does
...
those things, Yugen inherits the improvement without a line changing here.
...
from yugen.adapters.base import Adapter, AdapterResult, Availability, run_process, which
from yugen.adapters.ghidra import importer
from yugen.adapters.triage import TriageAdapter
from yugen.adapters.triage.detectors import RISKY_APIS
from yugen.errors import AdapterError, AdapterUnavailable
...
GHIDRA_ENV_VARS = ("YUGEN_GHIDRA_HOME", "GHIDRA_INSTALL_DIR", "GHIDRA_HOME")
