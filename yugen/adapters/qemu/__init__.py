...
Because of that, execution never happens implicitly. ``yugen analyze`` will
...
isolated machine can be imported anywhere with ``yugen import-trace``.
"""
...
class QemuAdapter(Adapter):
        ...
        if not self._binary:
            ...
            return Availability(
                ...
                remedy=(
                    ...
                    "yugen import-trace <log> --object <file>."
                ),
                cost=(
    ...
    def analyze(
        ...
        *,
        ...
        with tempfile.TemporaryDirectory(prefix="yugen-qemu-") as scratch:
