...
from yugen.adapters.base import Adapter, AdapterResult, Availability
from yugen.adapters.triage import detectors, formats, strings
...
class TriageAdapter(Adapter):
    ...
    def triage_into(
        ...
        *,
        ...
        hundreds of runs.
        """
        from yugen.adapters.ingest import ingest_file
