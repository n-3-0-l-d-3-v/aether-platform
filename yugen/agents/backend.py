...
Yugen has zero runtime dependencies (ADR 0001); this module talks to Ollama's
...
class LLMBackend(Protocol):
    ...
    def complete(self, prompt: str, *, max_tokens: int = 512) -> str:
        ...
        Raises :class:`yugen.errors.AdapterUnavailable` when the backend
...
class Availability:
    ...
    :class:`yugen.adapters.base.Availability` for the same reason: so the CLI
