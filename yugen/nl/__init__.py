...
returns an :class:`~yugen.nl.model.Answer` whose every explanatory line cites
...
from yugen.nl.questions import (
    MATCH_THRESHOLD,
    QUESTION_TYPES,
    PlanContext,
    QuestionType,
